...
module.exports = {
    ...
    async execute(message) {
        ...
        let baseReward = 100;
        let reward = baseReward + (profile.dailyStreak * 10); // Example: +10 per streak
        const maxStreakBonus = 500; // Max bonus to prevent excessive rewards
        ...
        // Update streak
        let newStreak = 1;
        if (profile.lastDaily && now - profile.lastDaily < cooldown + 1 * 60 * 1000) { // Allow 1 minute grace
