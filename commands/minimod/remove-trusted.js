...
module.exports = {
    name: 'remove-trusted',
    description: 'Removes the trusted role from the mentioned user.',
        ...
        try {
            ...
            if (!user) {
                const noMentionEmbed = new EmbedBuilder()
                    .setTitle('Error')
                    .setDescription('Please mention a user to remove the trusted role.')
                    .setColor('#FF0000');
            ...
            const successEmbed = new EmbedBuilder()
                ...
                .setDescription(`${message.author} successfully removed Trusted from ${user}.`)
                .setColor('#00FF00');
