...
async function createEconomyProfileIfNotExists(userId) {
    ...
    if (!existingProfile) {
        ...
        // Enforce numeric values if profile already exists
        const updates = {};
        ...
        // Only update if there are corrections needed
